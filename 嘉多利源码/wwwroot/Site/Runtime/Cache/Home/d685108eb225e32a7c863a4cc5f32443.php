      ...
      <div class="xq-detail">
          <div class="content">
            ...
            <div class="text">
              ...
              <div class="tel">
                <p>免费咨询热线：<span><?php echo ($phone); ?></span></p>
              </div>
            </div>
            ...
            <div class="xq-content">
              <div class="title">
                <ul>
                  <li><a href="#td">产品特点</a></li>
                  <li><a href="#cs">产品参数</a></li>
                  <li><a href="#al">案例展示</a></li>
                  <li><a href="#rel">系列产品</a></li>
                </ul>
              </div>
              <div class="contain #xq">
                <div id="td"><p class="biaoti">产品特点</p><?php echo ($content["Content"]); ?></div>
                <div id="cs"><p class="biaoti">产品参数</p><?php echo ($content["tedian"]); ?></div>
                <div id="al"><p class="biaoti">案例展示</p><?php echo ($content["shuoming"]); ?></div>
                <div id="rel">
                  <p class="biaoti">系列产品</p>
