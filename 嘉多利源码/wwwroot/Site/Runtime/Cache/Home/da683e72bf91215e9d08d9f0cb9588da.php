...
<div class="ny-content">
	...
	<div class="wrap">
        ...
        <div class="ny-left pc">
            <div class="title">
                <h2><?php $bname["name"]="测试方案"; $bname["remark"]=""; $bname["src"]="/Upload"; echo ($bname["name"]); ?></h2>
                <em><?php $bname["name"]="测试方案"; $bname["remark"]=""; $bname["src"]="/Upload"; echo ($bname["remark"]); ?></em>
            </div>
        ...
        <div class="ny-right">
            <p class="all"><em><?php $isid=""; $id=!empty($isid)?$isid:I("get.cid");$desclen="";$data=M("class")->where("ID=".$id)->find();$cname["src"]="/Upload".$data["Class_pic"];$cname["name"]=!myempty($data["Name"])?$data["Name"]:"Products";$cname["desc"]=substr_cut($data["Class_info"],$desclen);$cname["remark"]=$data["Remark"]; echo ($cname["name"]); ?></em> 共找到 <b><?php $pronum["num"]="2"; echo ($pronum["num"]); ?></b> 件产品</p>
            <ul class="ny-prolist">
