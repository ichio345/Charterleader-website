...
<div class="ny-content">
	...
	<div class="wrap"><div id="nr-container">
		...
		<div class="nr-info">
			发布时间：<?php echo (date('Y-m-d H:i:s',$content["Rdate"])); ?>   点击次数：<?php echo ($content["Click"]); ?>
		</div>
		<div class="nr-content">
			<?php echo ($content["Content"]); ?>
			<div class="prev">
				<?php echo L('prev');?>:<a href="<?php echo ($prev["link"]); ?>"><?php echo ($prev["title"]); ?></a>
			</div>
			<div class="next">
				<?php echo L('next');?>:<a href="<?php echo ($next["link"]); ?>"><?php echo ($next["title"]); ?></a>
			</div>
			<div class="returnbt">
				<input type='button' value='<?php echo L("back");?>' OnClick='history.back();'>
			</div>
		</div>
	</div></div>
