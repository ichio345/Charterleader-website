...
<?php if($_GET['cid'] == 244 or $_GET['cid'] == 309 ): else: ?>
    <div class="ny-column">
        <div class="wrap">
            <h2><?php $bname["name"]="联系我们"; $bname["remark"]="CONTACT US"; $bname["src"]="/Upload"; echo ($bname["name"]); ?></h2>
            <p><?php $bname["name"]="联系我们"; $bname["remark"]="CONTACT US"; $bname["src"]="/Upload"; echo ($bname["remark"]); ?></p>
        </div>
    </div><?php endif; ?>
			...
			<ul>
				<li>
					...
					<div class="add-bottom">
						<span>【电话】  0512-68087857</span>	
						<span>【邮箱】  web_sales@clpe.com.cn</span>	
						<span>【地址】 苏州新区滨河路625号创业大厦4栋</span>	
					</div>
				</li>
				<li>
					<div class="add-top">
					...
					<div class="add-bottom">
						<span>【电话】  0769-85098277</span>	
						<span>【邮箱】  sales_pts@programtek.com.cn</span>	
						<span>【地址】  东莞市长安镇振安东路76号</span>	
					</div>
				</li>
				<li>
					<div class="add-top">
				...
				<li>
					...
					<div class="add-bottom">
						<span>【电话】  886-2-27970115</span>	
						<span>【邮箱】  web_sales@clpe.com.cn</span>	
						<span>【地址】 台湾台北市内湖区文湖街2号2楼</span>	
					</div>
				</li>
				<li>
					<div class="add-top">
