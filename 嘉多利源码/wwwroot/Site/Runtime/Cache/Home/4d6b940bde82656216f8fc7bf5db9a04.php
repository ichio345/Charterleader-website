...
<div class="header">
 ...
 <!-- 语言版本 begin -->
        <div class="SelectControl" onmouseover="funcSetOn(this,1)" onmouseout="funcSetOn(this,0)" onclick="funcSel(this)" state="">
                <input readonly="readonly" value="中文" /><span class="arrow"></span>
                <ul style="display:none;">
                    <li ><a href="<?php echo U('Common/lang',array('lng'=>'cn'));?>">中文</a></li>
                    <li><a href="<?php echo U('/index');?>">English</a></li>
                </ul>
        </div>
        <!-- 语言版本 end -->
    ...
    <div class="lang-ver">
            <ul class="ver">
                <li class="on"><a href=""><img src="<?php echo C('TMURL');?>/images/cn.png"  alt="中文版">中文</a></li>
                <li><a href=""><img src="<?php echo C('TMURL');?>/images/en.png"  alt="English">EN</a></li>
            </ul>
            <div class="clear"></div>
...
<div class="i-menu">
  <div class="container-s">
      <ul class="i-menu-list c txt-c">
        <li><a href="<?php echo U('/index');?>">Hmoe</a></li>
        <?php
...
<?php if($_GET['cid'] == 244 or $_GET['cid'] == 309 ): else: ?>
    <div class="ny-column">
        <div class="wrap">
            <h2><?php $bname["name"]="Culture"; $bname["remark"]=""; $bname["src"]="/Upload"; echo ($bname["name"]); ?></h2>
            <p><?php $bname["name"]="Culture"; $bname["remark"]=""; $bname["src"]="/Upload"; echo ($bname["remark"]); ?></p>
        </div>
    </div><?php endif; ?>
...
<div class="ny-content">
    ...
    <div class="wrap">
      <ul class="display pc">
        <li>
          <img src="<?php echo C('TMURL');?>/images/s1.jpg" height="262" width="354" alt="" class="left">
          <div class="text width-s bg-red right bg1">
            <p>梦想 • 事业</p>
          </div>
        </li>
        <li>
          <img src="<?php echo C('TMURL');?>/images/s2.jpg" height="262" width="252"alt="" class="left">
          <div class="text width-l bg-orange right bg2">
            <p>学习 • 进步</p>
          </div>
        </li>
        <li>
          <img src="<?php echo C('TMURL');?>/images/s3.jpg" height="262" width="240" alt="" class="right">
          <div class="text width-l bg-orange left bg3">
            <p>家 • 天地</p>
          </div>
        </li>
        <li>
          <img src="<?php echo C('TMURL');?>/images/s4.jpg" height="262" width="354"  alt="" class="right">
          <div class="text width-m bg-yellow left bg4">
            <p>团队 • 协作</p>
          </div>
        </li>
        <li>
          <img src="<?php echo C('TMURL');?>/images/s5.jpg" height="262" width="354" alt="" class="left">
          <div class="text width-s bg-red right bg5">
            <p>专业 • 专注</p>
          </div>
        </li>
        <li>
          <img src="<?php echo C('TMURL');?>/images/s6.jpg" height="262" width="252"alt="" class="left">
          <div class="text width-l bg-orange right bg6">
            <p>快乐 • 创造</p>
          </div>
        </li>
      </ul>

      <ul class="display wap">
        <li>
          <div class="pic pbg1"></div>
          <div class="text bg-red bg1">
            <p>梦想 • 事业</p>
          </div>
        </li>
       <li>
          <div class="pic pbg2"></div>
          <div class="text bg-red bg2">
            <p>学习 • 进步</p>
          </div>
        </li>
        <li>
          <div class="pic pbg3"></div>
          <div class="text bg-red bg3">
            <p>家 • 天地</p>
          </div>
        </li>
        <li>
          <div class="pic pbg4"></div>
          <div class="text bg-red bg4">
            <p>团队 • 协作</p>
          </div>
        </li>
        <li>
          <div class="pic pbg5"></div>
          <div class="text bg-red bg5">
            <p>专业 • 专注</p>
          </div>
        </li>
        <li>
          <div class="pic pbg6"></div>
          <div class="text bg-red bg6">
            <p>快乐 • 创造</p>
          </div>
        </li>
      </ul>
      ...
      <div class="personal">
        ...
        <ul class="personal-list">
         <?php $db=M("pic");$where=array("path"=>array("like","%".I("cid")."%"),"Edition"=>C("EDITION"));$picTotalList=$db->where($where)->count();$picListNum=12;$page=Fpage($picTotalList,$picListNum);$pageshow=$page->show(); if(!myempty($where2)){ $data=$db->where($where)->where($where2)->limit("$page->firstRow,$page->listRows")->order('Sort DESC,ID DESC')->select(); }else{ $data=$db->where($where)->limit("$page->firstRow,$page->listRows")->order('Sort DESC,ID DESC')->select(); } foreach ($data as $Piclist) : $piclist=explode("###",$Piclist['Thumbnail'])[$Piclist['Cover']]; $picpath='Upload'.$piclist; if(!empty($piclist) && file_exists($picpath)){ $Piclist["src"]="/".$picpath; }else{ $Piclist["src"]='/Common/images/not-pic.jpg'; } $Piclist["title"]=substr_cut($Piclist["Title"],10); $Piclist["desc"]=substr_cut($Piclist["Description"],120); $Piclist["url"]=get_url($Piclist['ClassID'],$Piclist["ID"]); ?><li>
            <div class="pic">
              <img src="<?php echo ($Piclist["src"]); ?>" height="273" width="340">
            </div>
            <em><?php echo ($Piclist["title"]); ?></em>
            <p><?php echo ($Piclist["desc"]); ?></p>
            <a class="more pc"> +</a>
          </li><?php endforeach; ?>
        </ul>
         <div class="cl"></div>
