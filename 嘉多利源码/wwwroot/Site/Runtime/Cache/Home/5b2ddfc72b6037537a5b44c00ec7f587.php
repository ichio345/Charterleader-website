...
<?php if($_GET['cid'] == 268 or $_GET['cid'] == 267 ): else: ?>
    <div class="ny-column">
        <div class="wrap">
            <h2><?php $bname["name"]="合作伙伴"; $bname["remark"]=""; $bname["src"]="/Upload"; echo ($bname["name"]); ?></h2>
            <p><?php $bname["name"]="合作伙伴"; $bname["remark"]=""; $bname["src"]="/Upload"; echo ($bname["remark"]); ?></p>
        </div>
    </div><?php endif; ?>
