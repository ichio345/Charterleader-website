...
$(document).ready(function(){
	...
	<div class="title"><span class='add'></span><strong>修改幻灯片</strong></div>
		<div class="mrclass">
			<form action="<?php echo U('System/update_slide_form');?>" method="post">
				<div class="mrlist">
					<ul>
						<li>
							<input type="hidden" name="id" value="<?php echo ($slide["ID"]); ?>">
							<span class="mrtitle fl">标题：</span>
							<input type="text" name="title" class='mrinput' style="width:250px" value="<?php echo ($slide["Title"]); ?>">
							&nbsp;&nbsp;&nbsp;&nbsp;首页显示&nbsp;&nbsp;
							<input type="checkbox" <?php if($slide['is_index'] == 1): ?>checked='checked'<?php endif; ?> value="1" name='is_index'/>
						</li>
						<li>
							<span class="mrtitle fl">描述：</span>
							<textarea name="desc" class="mrtext" style="width:500px;height:50px"><?php echo ($slide["Desc"]); ?></textarea>
						</li>
						<li>
							<span class="mrtitle fl">链接地址：</span>
							<input type="text" name="linkurl" class='mrinput' style="width:250px" value="<?php echo ($slide["LinkUrl"]); ?>">
						</li>

						<li>
							<span class="mrtitle fl">排序：</span>
							<input type="text" name="sort" class='mrinput' style="width:250px" value="<?php echo ($slide["sort"]); ?>">
						</li>
...
<div class="uploader">
	<div id="uploader">
	    ...
	    <div id="fileList" class="uploader-list">
			<?php if(!empty($slide['PicUrl'])): ?><div class="tlist fl">
					<img src="/Upload<?php echo ($slide["PicUrl"]); ?>" width="120" height="100">
					<input type="hidden" name="filepath[]" value="<?php echo ($slide["PicUrl"]); ?>">
				</div><?php endif; ?>
	    </div>
	</div>	
</div>			
<script type="text/javascript">
   ...
   // 添加全局站点信息
    ...
    //删除图片的路径
    var PRO_DEL_PIC="<?php echo U('System/del_pic',array('table'=>'slide','field'=>'PicUrl'));?>";
    //产品ID
    var PID="<?php echo ($slide["ID"]); ?>";
</script>
<script type="text/javascript" src="<?php echo C('HTStyle');?>/webuploader/upcon.js"></script>
						</li>
					</ul>
