...
$(document).ready(function(){
	...
	<div class="main_right">
		<div class="title"><span class="add"></span><strong>添加内容</strong></div>
		<div class="mrclass jz">
			<form action="<?php echo U('add_about_form');?>"  id="yzform" method="post">
			<div class="mrlist">
				<ul>
					<li>
					...
					<li>
						...
						<input type="hidden" name="tablename" value="<?php echo ($about["TableName"]); ?>">
						<select name="classid" class="mrselect" >
							<?php if(is_array($about)): $i = 0; $__LIST__ = $about;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["ID"]); ?>">&nbsp;<?php echo ($vo["html"]); echo ($vo["Name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
						&nbsp;&nbsp;&nbsp;&nbsp;首页显示：
						<input type="checkbox" name="is_index" >
					</li>
					...
					<li>
						...
						<textarea name="Desc" class="mrtext"></textarea>	
					</li>
					<li>
