...
$(document).ready(function(){
	...
	<div class="main_right">
		...
		<div class="mrclass jz">
			<form action="<?php echo U('update_product_form');?>" method="post" id="yzform" enctype="multipart/form-data">
			<div class="mrlist">
				<ul>
					<li>
						<span class="mrtitle fl">产品标题：</span>
						<input type="text" name='title' class='mrinput' value="<?php echo ($up_art["Title"]); ?>" />
					</li>
					<li>
					...
					<?php if(is_array($bltype)): foreach($bltype as $key=>$vo): if($vo["type"] == textarea): ?><li>
								...
								<<?php echo ($vo["type"]); ?> name="class_type[value][<?php echo ($vo["id"]); ?>]" style='width:300px'><?php if(is_array($type_list)): foreach($type_list as $key=>$list): if($list["typeid"] == $vo["id"] ): echo ($type_list["$key"]["typevalue"]); endif; endforeach; endif; ?>
								</<?php echo ($vo["type"]); ?>> 
							</li>
						<?php else: ?>
							<li>
...
<script type="text/javascript" src="<?php echo C('HTStyle');?>/webuploader/upcon.js"></script>					
					...
					<li>
						...
						<input type="text" class="mrinput-default" value="<?php echo ($up_art['Cover']+1); ?>"  name='Cover'/>
						 ( 选择缩略图的序号为封面 )
					</li>
					<li>
					...
					<li>
                        ...
                        <textarea name='keyword' class="mrtext"><?php echo ($up_art["Keyword"]); ?></textarea>
					</li>
					<li>
                    ...
                    <li>
						...
						<div class="mrcontent fl">
						<textarea name="tedian" id='tedian'><?php echo ($up_art["tedian"]); ?></textarea>
						</div>
						<div class="cl"></div>
					</li>
                    <li>
						...
						<div class="mrcontent fl">
						<textarea name="shuoming" id='shuoming'><?php echo ($up_art["shuoming"]); ?></textarea>
						</div>
						<div class="cl"></div>
					</li>
				</ul>
