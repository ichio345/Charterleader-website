...
$(document).ready(function(){
	...
	<div class="main_right">
		...
		<div class="mrclass jz">
			<form action="<?php echo U('update_article_form');?>" method="post"  enctype="multipart/form-data">
			<div class="mrlist">
				<ul>
					<li>
...
<script type="text/javascript">	
   // 添加全局站点信息
    ...
    //删除图片的路径
    var PRO_DEL_PIC="<?php echo U('Article/del_pic');?>";
    //产品ID
...
<script type="text/javascript" src="<?php echo C('HTStyle');?>/webuploader/upcon.js"></script>					
					...
					<li>
						...
						<input type="text" class="mrinput-default"  name='Cover' value="<?php echo ($up_art['Cover']+1); ?>"/>
						 ( 选择缩略图的序号为封面 )
					</li>
					<li>
					...
					<li>
						...
						<input type="text" name='Rdate' class='mrinput rdate' value="<?php echo (date('Y-m-d H:i:s',$up_art["Rdate"])); ?>" />
					</li>
					<script type="text/javascript">
