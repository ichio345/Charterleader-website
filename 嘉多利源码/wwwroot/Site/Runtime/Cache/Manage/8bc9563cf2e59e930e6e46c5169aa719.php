...
$(document).ready(function(){
	...
	<div class="title"><span></span><strong>管理员列表</strong><a href="<?php echo U('User/add_user');?>" class="op">添加管理员</a></div>
		<div class="list">
			<table  cellpadding="0" cellspacing="0">
				<tr><th width="10%">管理员ID</th><th width="10%">管理员名</th><th width="12%" >管理员身份</th><th style="border:none;text-align:right">操作</th></tr>	
				<?php if(is_array($ma)): $i = 0; $__LIST__ = $ma;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td  align="right" style="border-right:0">
							...
							<!-- <a href="#" onclick="return confirm('你确定要删除吗?')">[删除]</a> -->
						</td>	
