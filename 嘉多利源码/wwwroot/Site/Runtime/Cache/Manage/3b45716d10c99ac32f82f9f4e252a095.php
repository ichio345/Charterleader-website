...
$(document).ready(function(){
	...
	<div class="main_right">
		<div class="title"><span class="add"></span><strong>添加图片</strong></div>
		<div class="mrclass jz">
			<form action="<?php echo U('add_pic_from');?>" method="post" id="yzform" enctype="multipart/form-data" >
			<div class="mrlist">
				<ul>
					<li>
					...
					<li>
						...
						<select name="classid" class="mrselect">
							<?php if(is_array($pic)): $i = 0; $__LIST__ = $pic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["ID"]); ?>">&nbsp;<?php echo ($vo["html"]); echo ($vo["Name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
						&nbsp;&nbsp;&nbsp;&nbsp;首页显示
