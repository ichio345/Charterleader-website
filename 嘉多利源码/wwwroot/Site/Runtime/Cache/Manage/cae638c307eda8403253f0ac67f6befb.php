...
$(document).ready(function(){
	...
	<div class="title"><span class='add'></span><strong>修改友情链接</strong></div>
		<div class="mrclass">
			<form action="<?php echo U('System/updata_link');?>" method="post">
				<div class="mrlist">
					<ul>
						<li>
							<span class="mrtitle fl">链接名称：</span>
							<input type="hidden" name="id" value="<?php echo ($link["id"]); ?>"></input>
							<input type="text" name="linkname" class='mrinput' style="width:250px" value="<?php echo ($link["linkname"]); ?>" >
							&nbsp;&nbsp;&nbsp;&nbsp;是否开启&nbsp;&nbsp;
							<input type="checkbox" checked="checked" <?php if($link['is_show'] == 1): ?>checked='checked'<?php endif; ?> value="1" name='is_show'/>
						</li>
						<li>
							<span class="mrtitle fl">链接地址：</span>
							<input type="text" name="linkurl" value="<?php echo ($link["linkurl"]); ?>" class='mrinput' style="width:250px" >
						</li>
						<li>
							<span class="mrtitle fl">排序</span>
							<input type="text" name="linkorder"  value="<?php echo ($link["linkorder"]); ?>" class='mrinput' style="width:250px" >
						</li>
<div class="uploader">
	<div id="uploader">
		<div id="filePicker">点击上传图片</div>
	    <div id="fileList" class="uploader-list">
			<?php if(!empty($link['linkpic'])): ?><div class="tlist fl">
					<img src="/Upload<?php echo ($link["linkpic"]); ?>" width="120" height="100">
					<input type="hidden" name="filepath[]" value="<?php echo ($link["linkpic"]); ?>">
				</div><?php endif; ?>
	    </div>
	</div>	
</div>			
<script type="text/javascript">	
   // 添加全局站点信息
    ...
    //删除图片的路径
    var PRO_DEL_PIC="<?php echo U('System/del_pic',array('table'=>'link','field'=>'linkurl'));?>";
    //产品ID
    var PID="<?php echo ($vo['id']); ?>";
</script>
<script type="text/javascript" src="<?php echo C('HTStyle');?>/webuploader/upcon.js"></script>
				...
				<a href="<?php echo U('link');?>" class="ret ml10">返回</a>
			</form>
