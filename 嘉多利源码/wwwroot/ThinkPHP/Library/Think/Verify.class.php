...
class Verify {
    ...
    public function entry($id = '') {
        ...
        // 验证码字体随机颜色
        $this->_color = imagecolorallocate($this->_image, mt_rand(1,140), mt_rand(1,140), mt_rand(1,140));
        // 验证码使用随机字体
    ...
    private function _writeNoise() {
        ...
        for($i = 0; $i < 10; $i++){
            //杂点颜色
            $noiseColor = imagecolorallocate($this->_image, mt_rand(180,225), mt_rand(180,225), mt_rand(180,225));
            for($j = 0; $j < 5; $j++) {
                // 绘杂点
