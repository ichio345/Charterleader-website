...
jQuery(".product-recommend").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:6,interTime:30,trigger:"click"});
...
jQuery(".test-center").slide({mainCell:".bd ul",autoPlay:true,effect:"leftMarquee",vis:3,interTime:30,trigger:"click"});
